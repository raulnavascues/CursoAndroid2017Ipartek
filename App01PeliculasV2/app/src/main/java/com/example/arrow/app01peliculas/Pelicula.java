...
public class Pelicula {
    ...
    public Pelicula(String titulo, String anio, String pais, int duraccion, int caratulaMini) {
        this.titulo = titulo;
        this.anio = anio;
        this.pais = pais;
    ...
    public Pelicula(String titulo, String anio, String pais, int duraccion, String director, String sipnosis, String guinista, int caratulaMini, int caratula) {
        this.titulo = titulo;
        this.anio = anio;
        this.pais = pais;
        this.duraccion = duraccion;
